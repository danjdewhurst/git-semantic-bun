...
describe("perf guardrails", () => {
  ...
  it("detects regressions above thresholds", () => {
    const baseline = {
      cold: { count: 1, minMs: 40, maxMs: 40, meanMs: 40, stddevMs: 0, p50Ms: 40, p95Ms: 40 },
      warm: { count: 1, minMs: 10, maxMs: 10, meanMs: 10, stddevMs: 0, p50Ms: 10, p95Ms: 10 },
      indexLoad: { count: 1, minMs: 5, maxMs: 5, meanMs: 5, stddevMs: 0, p50Ms: 5, p95Ms: 5 },
    };
    const current = {
      cold: { count: 1, minMs: 52, maxMs: 52, meanMs: 52, stddevMs: 0, p50Ms: 52, p95Ms: 52 },
      warm: { count: 1, minMs: 11, maxMs: 11, meanMs: 11, stddevMs: 0, p50Ms: 11, p95Ms: 11 },
      indexLoad: { count: 1, minMs: 7, maxMs: 7, meanMs: 7, stddevMs: 0, p50Ms: 7, p95Ms: 7 },
    };
